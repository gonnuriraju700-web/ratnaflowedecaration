        ...
        <div class="footer-grid">
          ...
          <div class="footer-brand">
            ...
            <div class="footer-social">
              <a href="https://www.instagram.com/ranga_flower_decorations/reel/DcGlLvdJP5_/" target="_blank" rel="noopener noreferrer" class="footer-social-icon" aria-label="Instagram">
                <i class="bi bi-instagram" aria-hidden="true"></i>
              </a>
              <a href="https://www.facebook.com/p/Ratna-Flower-Decorations-61591494534110/" class="footer-social-icon" aria-label="Facebook">
                <i class="bi bi-facebook" aria-hidden="true"></i>
              </a>
              <a href="https://www.youtube.com/results?search_query=ratna+flower+decoration" class="footer-social-icon" aria-label="YouTube">
          ...
          <div class="footer-col">
            ...
            <ul class="footer-contact">
              <li>
                ...
                <span>+91 6262611125</span>
              </li>
              <li>
                <i class="bi bi-envelope" aria-hidden="true"></i>
                <span>ratnamflowerdecoration@gmail.com</span>
              </li>
              <li>
                <i class="bi bi-geo-alt" aria-hidden="true"></i>
                <span>Ave Appa Rao Rd, near HP Petrol Pump, Srinivas Nagar, Gandhipuram, Rajamahendravaram, Andhra Pradesh 533103</span>
              </li>
            </ul>
          </div>
        </div>
