          ...
          <div class="contact-info" appReveal="fade-right">
            ...
            <div class="contact-social">
              ...
              <div class="contact-social-icons">
                <a href="https://www.instagram.com/ranga_flower_decorations/reel/DcGlLvdJP5_/" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Instagram"><i class="bi bi-instagram" aria-hidden="true"></i></a>
                <a href="https://www.facebook.com/p/Ratna-Flower-Decorations-61591494534110/" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Facebook"><i class="bi bi-facebook" aria-hidden="true"></i></a>
                <a href="https://www.youtube.com/results?search_query=ratna+flower+decoration" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="YouTube"><i class="bi bi-youtube" aria-hidden="true"></i></a>
                <a href="https://wa.me/6262611125?text=Hi%20Ratnaa%20Flowers%2C%20I'd%20like%20to%20enquire%20about%20your%20decoration%20services." target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="WhatsApp"><i class="bi bi-whatsapp" aria-hidden="true"></i></a>
              </div>
            </div>
          </div>
...
export class ContactComponent {
  ...
  contactInfo: ContactInfo[] = [
    { icon: 'bi bi-telephone-fill', label: 'Phone', value: '+91 6262611125' },
